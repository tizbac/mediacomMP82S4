...
static struct regulator_consumer_supply ldo6_data[] = {
		{
			.supply = "act_ldo8",//vcc28_cif dldo2 "axp22_dldo2",
		},
	};
...
static struct regulator_consumer_supply ldo11_data[] = {
		{
			.supply = "act_ldo3",//vcc18_cif eldo3 "axp22_eldo3",
		},
	};
...
static struct regulator_consumer_supply DCDC1_data[] = {
		{
			.supply = "axp22_dcdc1",//vcc_io 3.0v   
		},
	};

static struct regulator_consumer_supply DCDC2_data[] = {
		{
			.supply = "axp22_dcdc2",//avdd_com 1.1v
		},
		{
			.supply = "vdd_cpu",
		},
...
static struct regulator_consumer_supply DCDC3_data[] = {
		{
			.supply = "axp22_dcdc3",//vdd_arm 1.1v
		},
		{
			.supply = "vdd_core",
		},
...
static struct regulator_consumer_supply DCDC5_data[] = {
		{
			.supply = "axp22_dcdc5", //vcc_ddr 1.5v
		},
	};
...
static struct power_supply_info battery_data ={
		...
		.voltage_max_design = CHGVOL*1000,
		.voltage_min_design = SHUTDOWNVOL,
		.energy_full_design = 4000,//BATCAP,
		.use_for_apm = 1,
};
...
{
	axp_sply_init_data.chgcur = STACHGCUR;
	battery_data.energy_full_design = BATCAP;
