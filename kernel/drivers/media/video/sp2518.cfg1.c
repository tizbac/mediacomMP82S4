...
#define CONFIG_SENSOR_I2C_SPEED     50000	///250000       /* Hz */
...
#define  SP2518_P0_0xdd  0x7c//0x80

#define  SP2518_P0_0xde  0x98
...
static struct reginfo sensor_init_data[] =
{
	...
	{0x0e,0x01},
	//{0x36,0x20},//disable hs vs for test 20130609wyq
	{0x0f,0x2f},
	{0x10,0x2e},
	{0x11,0x00},
	{0x12,0x4f},
...
//	{0x15,0x18},
	...
	{0x9d,0x38},	
	#if 0
	///SP2518 UXGA 24MEclk 2倍频 1分频 50Hz fix 9fps
	{0xfd , 0x00},
	{0x03 , 0x02},
	{0x04 , 0x70},
	{0x05 , 0x00},
	...
	{0xfd , 0x00},
	#else
	//SI50_SP2518 UXGA 24MEclk 2倍频 1分频 50Hz fix 9fps(8.5) modify by sp_yjp,20140109
	//ae setting
	{0xfd , 0x00},
	{0x03 , 0x02},
	{0x04 , 0x9a},
...
*/
	...
	//{0x36,0xc0},//disable hs vs for test 20130609wyq
...
static int sensor_s_fmt(struct v4l2_subdev *sd, struct v4l2_mbus_framefmt *mf)
{
    ...
    else if (((set_w <= 800) && (set_h <= 600)))
    {
        if (sensor_svga[0].reg!=0xff) {
            ...
            set_w = 640-8;
            set_h = 480-6;
        } else if (sensor_qvga[0].reg!=0xff) {
            winseqe_set_addr = sensor_qvga;
            set_w = 320-8;
            set_h = 240-6;
