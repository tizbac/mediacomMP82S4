...
#define SENSOR_NAME CONS(RK29_CAM_SENSOR_SP2518,_mk13)  
...
#if 1	//20130717 debug by sp_yjp
{
	{0xfd , 0x00},
	{0x1b , 0x12},	//02 0a 12 1a
	{0x0e , 0x01},
	{0x0f , 0x2f},
	{0x10 , 0x2e},
	{0x11 , 0x00},
	...
	//SI50_SP2518 UXGA 24MEclk 2±¶Æµ 1·ÖÆµ 50Hz fix 8.5fps //modify by sp_yjp,20130717
	//ae setting
{0xfd , 0x00},
{0x03 , 0x02},
{0x04 , 0x9a},
...
{0xfd , 0x00},
	...
	#else
	//SI50_SP2518 UXGA 24MEclk 2±¶Æµ 1·ÖÆµ 60Hz fix 8.5fps//modify by sp_yjp,20130717
	//ae setting
{0xfd , 0x00},
{0x03 , 0x02},
{0x04 , 0x28},
...
{0xfd , 0x00},
	...
	{0xfd , 0x00},
		...
		///lens shading for èˆœæ³°979C-171A\181A
	{0xfd , 0x00}, 
	{0xa1 , 0x20},
	{0xa2 , 0x20},
	{0xa3 , 0x20},
