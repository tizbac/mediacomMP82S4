...
//AE target
#define  SP0718_P1_0xeb  0x78-0x08
#define  SP0718_P1_0xec  0x6c-0x08
//HEQ
#define  SP0718_P1_0x10  0x00//outdoor
#define  SP0718_P1_0x14  0x18//0x20
#define  SP0718_P1_0x11  0x00//nr
#define  SP0718_P1_0x15  0x18//0x18
#define  SP0718_P1_0x12  0x00//dummy
#define  SP0718_P1_0x16  0x14
#define  SP0718_P1_0x13  0x00//low
#define  SP0718_P1_0x17  0x08//0x00
...
{		//saturday param test
		{0xfd , 0x00},
		{0x1C , 0x14},// 00 20130511
		{0x1F , 0x10},// ADD 20130511
		{0x31 , 0x00},
...
//outdoor r\b range
  ...
  {0x7b , 0x99},
		...
		{0x65,0x22},
		{0x6d,0x06},//8//强平滑（平坦）区域平滑阈值
		{0x6e,0x08},//8
		{0x6f,0x10},
		{0x70,0x10},
		{0x71,0x0c},//0d//弱平滑（非平坦）区域平滑阈值	
		{0x72,0x14},//1b
		{0x73,0x20},//20
		{0x74,0x24},
...
static int sensor_init(struct v4l2_subdev *sd, u32 val)
{
   ...
   /* ret = sensor_write(client, 0x12, 0x80);
	...
	if(sensor->sensor_gpio_res->gpio_flag & 0x10000){
		...
		sensor_write(client, 0x31 , 0x60);
    }else{
		sensor_write(client, 0xfd , 0x00);
		sensor_write(client, 0x31 , 0x00);
	}
