...
#define SENSOR_NAME CONS(RK29_CAM_SENSOR_SP2518,_mp18)  
...
#if 1	//20120803 param
{
	...
	//SI50_SP2518 UXGA 24MEclk 2PLL 1DIV 50Hz fix 9fps	//modify by sp_yjp,20130423
	//ae setting
	{0xfd , 0x00},
	{0x03 , 0x02},
	{0x04 , 0xbe},
	...
	{0xfd , 0x00},
	#else
	//SI50_SP2518 UXGA 24MEclk 2PLL 1DIV 60Hz fix 9fps	//modify by sp_yjp,20130423
	//ae setting
	{0xfd , 0x00},
	{0x03 , 0x02},
	{0x04 , 0x4c},
...
static  struct reginfo sensor_SceneNight[] =
{
	...
	#if SP2518_FLICK_50HZ
	//SI50_SP2518 UXGA 24MEclk 2PLL 1DIV 50Hz fix 6fps	//modify by sp_yjp,20130423
	//ae setting
	{0xfd , 0x00},
	{0x03 , 0x01},
	{0x04 , 0xd4},
	...
	#else
	//SI50_SP2518 UXGA 24MEclk 2PLL 1DIV 60Hz fix 6fps	//modify by sp_yjp,20130423
	//ae setting
	{0xfd , 0x00},
	{0x03 , 0x01},
	{0x04 , 0x86},
